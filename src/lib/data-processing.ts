...
// Conteúdo do seu arquivo CSV padrão
const DEFAULT_CSV_CONTENT = `﻿;Receitas;;;;;;;;;;;;;;;;;Resltado_Custos;;;Contabilidade;Marca;Jurídico;Infraestrutura;Desenvolvimento;Desenvolvimento;Infraestrutura;Infraestrutura;Marketing;Marketing;Pessoal;Parcerias;Parcerias;Marketing;MKT 
...
export const parseCsvData = (csvContent: string = DEFAULT_CSV_CONTENT): FinanceRecord[] => {
...
export const parseFullRawCsvData = (csvContent: string = DEFAULT_CSV_CONTENT): string[][] => {
  const records = parse(csvContent, {
    delimiter: ';',
    relax_column_count: true,
    // Não pular linhas, queremos tudo
  });
